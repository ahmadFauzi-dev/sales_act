 ...
 */
$config['site_title']                 = "GratiaID";       // Site Title, example.com
$config['admin_email']                = "admin@gratia.co.id"; // Admin Email, admin@example.com
$config['default_group']              = 'GUEST';           // Default group, use name
...
$config['forgot_password_expiration'] = 600;                   // The number of seconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
...
$config['email_templates'] = '_system_/auth/email/';
