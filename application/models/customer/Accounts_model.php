...
*/
class accounts_model extends KOJE_Model
{
  function do_edit($params=false) {
		$input  = $this->getInput($params);
		$result = $this->CI->app_db->AccountsEdit($input);
		return $result;
  }
  ...
  function form_account_edit($params=false)
  {
		return array(
					'title'	=> 'Form Edit',
					'item'	=> array(
											...
											//'address_province' => array('type' => 'text', "rules" => "trim"),
