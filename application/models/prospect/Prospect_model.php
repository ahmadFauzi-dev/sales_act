...
class prospect_model extends KOJE_Model
{
  ...
  function do_upload($params=false)
  {
	...
	function do_edit($params=false) {
			$input  = $this->getInput($params);
			$result = $this->CI->app_db->ProspectEdit($input);
			return $result;
	}
	...
	function form_canvassing($params=false)
	{
		return array(
					...
					'item'	=> array(
											...
											'company_name'=> array( 'type' => 'pickList', 
                                                      ...
                                                      'pickListAssign' => array (
														...
														'cp_2_salute_desc'  => 'cp_2_salute_desc',
														'cp_2_name'  => 'cp_2_name',
											...
											'prospect_name'=> array('type' => 'text', "rules" => "trim"), 
											...
											'region_desc'   => array('type' => 'text', "rules" => "trim", "readonly" => true),
											
											'address_area'   => array('type' => 'text', "rules" => "trim", "readonly" => true),
											'industry'   => array('type' => 'text', "rules" => "trim", "readonly" => true),
											'address_zip'   => array('type' => 'text', "rules" => "trim", "readonly" => true),
											
											'address_city_id' => array('type' => 'hidden', "rules" => "trim", "readonly" => true),
											'address_city' => array('type' => 'text', "rules" => "trim", "readonly" => true),
											
											'address_street'   => array('type' => 'text', "rules" => "trim", "readonly" => true),
											
											'cp_1_info'  =>  array('type' => 'text', "rules" => "trim", "readonly" => true),
											
											'cp_1_salute'  => array('type' => 'hidden', "rules" => "trim", "readonly" => true),
											'cp_1_salute_desc'  => array('type' => 'text', "rules" => "trim", "readonly" => true),
											...
											'cp_1_department' 	 => array('type' => 'text', "rules" => "trim", "readonly" => true),
											
											'cp_2_info'  =>  array('type' => 'text', "rules" => "trim", "readonly" => true),
											
											'cp_2_salute'  => array('type' => 'hidden', "rules" => "trim", "readonly" => true),
											'cp_2_salute_desc'  => array('type' => 'text', "rules" => "trim", "readonly" => true),
											
											'cp_2_name'    => array('type' => 'text', "rules" => "trim" , "readonly" => true),
											'cp_2_mobile'  => array('type' => 'text', "rules" => "trim", "readonly" => true),
											'cp_2_email' 	 => array('type' => 'text', "rules" => "trim", "readonly" => true),
											'cp_2_department' 	 => array('type' => 'text', "rules" => "trim", "readonly" => true),
											
											'source' => array('type' => 'hidden', "rules" => "trim", "readonly" => true),
											'source_desc' => array('type' => 'text', "rules" => "trim", "readonly" => true),
			...
			'display' => array(
                      ...
                      html_col2Start(),
                        html_blockStart(),
  												html_blockHeader("Contact Person 1"),
                          array(
  															'cp_1_salute_desc',
  															'cp_1_info',
  															'cp_1_name',
						...
						html_col2Start(),
                        html_blockStart(),
  												html_blockHeader("Contact Person 2"),
                          array(
  															'cp_2_salute_desc',
  															'cp_2_info',
  															'cp_2_name',
  ...
  function form_prospect($params=false)
  {
    ...
    return array(
					...
					'item'	=> array(
											...
											'prospect_no' => array('type'	=> 'text'),
                      'prospect_start_date'  => array('type' => 'datePicker', "rules" => "trim|required"),
                      'prospect_type'=> array('type' => 'select2', "rules" => "trim|required", "value"=>'PSTY-01', 'options'	=> $this->CI->koje_system->getRefDomainList('PROSPECT__TYPE')),
											...
											'company_name' => array('readonly'	=> true, 'type'	=> 'text',"rules" => "trim|required"),
											'company_phone' =>  array('type'	=> 'text',"rules" => "trim"),
											'address_name' =>  array('type'	=> 'text',"rules" => "trim"),
											'company_npwp' => array('readonly'	=> true, 'type'	=> 'text',"rules" => "trim"),
											'company_anniversary' =>  array('type'	=> 'datePicker', "rules" => "trim"),
											'company_address_info' =>  array('type'	=> 'text', "rules" => "trim"),
											'd_segmentation' => array('type'	=> 'select2','options'	=> $this->CI->app_lib->getBillingSegmentation(),"rules" => "trim"),
											'd_customer_group' => array('type'	=> 'select2','options'	=> $this->CI->app_lib->getBillingGroup(),"rules" => "trim"),
											...
											'address_zip' =>  array('type'	=> 'text',"rules" => "trim"),
											'cp_1_salute' =>  array('type'	=> 'select2','options'	=> $this->CI->koje_system->getRefDomainList('LEAD__SALUTE'),"rules" => "trim"),
											'cp_1_name' =>  array('type'	=> 'text',"rules" => "trim"),
											'cp_1_department' => array('type'	=> 'text',"rules" => "trim"),
											'cp_1_mobile' => array('type'	=> 'text', "rules" => "trim" ),
											'cp_1_email' =>  array('type'	=> 'text', "rules" => "trim" ),
											'cp_1_info' =>  array('type'	=> 'textarea', "rules" => "trim" ),
											'cp_2_salute' =>  array('type'	=> 'select2', 'options'	=> $this->CI->koje_system->getRefDomainList('LEAD__SALUTE'), "rules" => "trim"),
											'cp_2_name' =>  array('type'	=> 'text',"rules" => "trim"),
											'cp_2_department' =>  array('type'	=> 'text',"rules" => "trim"),
											'cp_2_mobile' =>  array('type'	=> 'text',"rules" => "trim"),
											'cp_2_email' =>  array('type'	=> 'text',"rules" => "trim"),
											'cp_2_info' =>  array('type'	=> 'textarea',"rules" => "trim"),
										  ...
										  'company_curr_service' => array('type'	=> 'text',"rules" => "trim"),
										  'company_curr_provider' => array('type'	=> 'text',"rules" => "trim"),
											...
											'company_curr_expense' => array('type'	=> 'text',"rules" => "trim"),
			...
			'display' => array(
                      ...
                      array($this->CI->app_lib->generateRequirement($_REQUEST,$btnAdd)),
										...
										html_blockStart(),
											html_blockHeader(""),
                      array($this->CI->app_lib->getOportunityDoc($_REQUEST)),
										html_blockEnd(),
										html_col1Start(),
										html_blockStart(),
			...
			'result' => array('prospect_name','company_name','d_segmentation','d_customer_group','presales_status','presales_desc')
			);
  }
  ...
  function form_manage_doc($params = false)
  {
    $form = array(
      ...
      'item'  => array(
        ...
        'doc_type'              => array('type' => 'select', 'rules' => 'trim|required', 'options' => $this->CI->app_lib->getReferenceDoc('DOCUMENT__TYPE','SALES')),
