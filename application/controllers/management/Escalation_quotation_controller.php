...
class escalation_quotation_controller extends KOJE_Controller {

	var $modelClassFile	= 'prospect/negotiation_model';
	var $modelClassName	= 'negotiation_model';
	var $view  					= 'management/escalation_quotation_view';
	...
	{
		$this->params['FORMS'] 			= $this->modelClass->getForm('form_quotation_escalation',$params,false);
