...
class proposal_request_controller extends KOJE_Controller {
	...
	function __construct() {
		...
		$this->params = array();
		$this->load->model('presales/prospect_model');
		$this->view  = 'presales/proposal_request_view';
	...
	function edit($params=false)
	{
		...
		{
			$this->params['RESULT'] 	= $this->prospect_model->do_edit_presales($this->params);
	...
	{ 
    	...
    	$this->params['FORMS'] = $this->prospect_model->getForm($this->params['MODEL'],$this->params);
		$this->params['FORMS']['url_back'] =array('url' => "presales/proposal_request_controller/edit",
